...
class ZonesControllerTest < ActionController::TestCase
  ...
  test "should create zone" do
    assert_difference('Zone.count') do
      post :create, zone: { description: @zone.description, name: @zone.name, nursing_home_id: @zone.nursing_home_id }
    end
  ...
  test "should update zone" do
    patch :update, id: @zone, zone: { description: @zone.description, name: @zone.name, nursing_home_id: @zone.nursing_home_id }
    assert_redirected_to zone_path(assigns(:zone))
  end
